...
If the tool is disabled by default, the instructor must first [ organize the navigation tabs](https://community.canvaslms.com/t5/Instructor-Guide/How-do-I-manage-Course-Navigation-links/ta-p/1020) to surface the LTI launch point.
