...
**Trigger:** Triggered when title, body, or workflow_state of wiki page is altered.
...
| **workflow_state** | The current workflow_state of the wiki page. Possible values are "active", "unpublished", and "deleted". |
