...
> Canvas LMS REST API — `/inst_access_tokens` resource. Base path `/api`.

## POST /v1/inst_access_tokens

**Create InstAccess token**  —  `create_instaccess_token`
