...
- Requires support for [IMS Common Cartridge](https://www.imsglobal.org/activity/common-cartridge) or [Thin Common Cartridge](https://www.imsglobal.org/cc/CCv1p0thin/ims_thinCC_impl-v1p0.html) by the tool.
