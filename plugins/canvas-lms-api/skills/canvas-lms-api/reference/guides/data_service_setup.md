...
3. Choose Delivery Method
 ...
 - If a customer's HTTPS service experiences an outage, the events will not be delivered until the service is recovered. See HTTPS delivery failures for more info.
