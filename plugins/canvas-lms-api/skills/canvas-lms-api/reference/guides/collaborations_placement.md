...
The IDs in the `groups` array are also IDs available in the Names & Roles Provisioning Service. When making a request in the NRPS to list Group Memberships, the response's `context.id` attribute is the ID to include.
